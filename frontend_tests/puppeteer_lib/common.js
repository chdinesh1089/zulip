...
class CommonUtils {
    ...
    // This method takes in page, table form which to get
    // the messages from, and expected messages. The format
    // of expected message is { "stream > topic": [messages] }.
    // The method will only check that all the messages in the
    // messages array passed exsist in the order they are passed.
