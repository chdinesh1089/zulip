...
async function subscriptions_tests(page) {
    ...
    const verona_unsubscribed_selector = "[data-stream-name='Verona'] .sub_unsub_button:not(.checked)";
    ...
    // Assert subscriber count becomes 4(scotland(+4), cordelia(+1), othello(-1)).
